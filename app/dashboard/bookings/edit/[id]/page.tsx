          ...
          <div className="flex flex-col gap-2 text-red-700 bg-red-50 border border-red-200 px-4 py-3 rounded">
            ...
            {overlapData && (
              <div className="mt-2 text-sm border-t border-red-200 pt-3">
                ...
                <p className="mb-3 text-red-700">هل ترغب في استكمال أو تعديل هذا الحجز بدلاً من ذلك؟</p>
                <Link
                ...
                >
                  {overlapData.type === 'ical' ? 'استكمال هذا الحجز (iCal)' : 'تعديل هذا الحجز المتعارض'}
