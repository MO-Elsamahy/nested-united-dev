...
import { Megaphone, Plus, Pin, Trash2, Calendar, Edit2, X, ChevronLeft } from "lucide-react";
            ...
            <div className="grid gap-4">
                {loading ? (
                    ...
                    announcements.map((ann) => (
                        <div
                            key={ann.id}
                            className={`bg-white rounded-xl shadow-sm border p-6 flex flex-col md:flex-row gap-4 items-start md:items-center justify-between ${ann.priority === 'urgent' ? 'border-red-200 bg-red-50' :
                        ...
                        >
                            ...
                            >
                                ...
                                <h3 className="font-bold text-gray-900 text-lg mb-1 group-hover:text-violet-700 transition">{ann.title}</h3>
                                <p className="text-gray-600 line-clamp-2">{ann.content}</p>
                                <span className="inline-flex items-center gap-1 text-violet-600 text-xs mt-2 opacity-0 group-hover:opacity-100 transition">
                                    <ChevronLeft className="w-3 h-3" />
                                    اضغط لعرض المحتوى الكامل
                                </span>
                            </div>
