                ...
                <div className="text-center mb-12 space-y-6">
                    ...
                    <div className="space-y-2">
                        <h1 className="text-4xl md:text-5xl font-bold text-slate-900 tracking-tight">
                            مرحباً بك، <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">{user.name}</span>
                        </h1>
                        <p className="text-slate-500 text-lg max-w-md mx-auto">اختر النظام الذي تود العمل عليه اليوم</p>
                    </div>
                </div>
