...
import { FileBarChart, Calendar, CheckCircle, XCircle, Printer, ArrowRight } from "lucide-react";
                ...
                <div className="bg-white rounded-2xl shadow-sm border p-8">
                    ...
                    <div className="print-only-header">
                        ...
                        <div className="company-info flex items-center gap-4">
                            ...
                            {/* Uses the same logo displayed in the nav if needed, or static text for safety */}
